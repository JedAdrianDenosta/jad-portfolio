  ...
  return (
    <AuroraBackground>
      ...
      >
        <section
          id="#home"
          className="mx-auto w-full text-zinc-800 max-w-5xl pb-16 px-6 pt-2 sm:p-10 md:px-14 md:pt-10 md:pb-24 lg:px-16 lg:pt-6 xl:px-0 xl:pt-10 xl:pb-24"
        >
            ...
            <div className="w-full space-y-10">
              <div className="space-y-8">
                ...
                <p className=" text-sm font-light max-w-lg sm:text-base">
                  ...
                  creating intuitive interfaces, I strive to merge aesthetics
                  and functionality seamlessly in every project.
                </p>
              </div>
